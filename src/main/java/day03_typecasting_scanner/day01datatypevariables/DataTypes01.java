package day03_typecasting_scanner.day01datatypevariables;
...
//How to name a class: i)Start with upper cases
            //ii)If you have multiple words, every word should start
            // with upper cases iii)Other characters should be in lower cases iv)You can use digits in naming

...
*5) "Non-Primitive" data types have i) Value and ii) Method in them
    "Primitive" data types have i)Value
 */
    /*
1) When you create a String, Java will check "String Pool" first, if the value you assigned to the String in the "String Pool", Java will not create a new container, Java will use existing container.
...
2) Sometimes we may need a different container even the values are same. How can we do it?
  String parentName = new String("Tom Hanks"): definitely creates a new contanier in memory
